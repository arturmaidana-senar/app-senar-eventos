...
export default function ValidatePin() {
	...
	return (
		<Container>
			...
			<Description>
				Te enviamos o código PIN por e-mail, mas confira também sua caixa de spam.
			</Description>
			...
			<ContinueButton onPress={validatePin} disabled={pin.length != 5} backgroundColor={continueButtonColor}>
